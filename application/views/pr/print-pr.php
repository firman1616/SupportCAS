...
<body>
    <table class="table_header">
        <tr>
            ...
            <td width="243">
                <h1 style="padding-top: 4pt; padding-left: 0pt; text-indent: 0pt; line-height: 14pt; text-align: center; margin-bottom: 5px;">PURCHASE REQUEST</h1>
                <table width="200" class="no_soe">
                    <tr>
                        <td style="text-align: center; font-weight: bold;"><?= $no_prq ?></td>
                    </tr>
                </table>
    ...
    <table width="500" style="margin-left: 9pt;">
        <tr>
            <td width="500">
                <h3 style="padding-top: 4pt;text-indent: 0pt;text-align: right;">Tanggal</h3>
            </td>
            <td width="10">
                <h3 style="padding-top: 4pt; text-indent: 0pt; text-align: center;">:</h3>
            </td>
            <td width="50">
                <h3 style="padding-top: 4pt; text-indent: 0pt; text-align: left;"> <?= date('d/m/Y',strtotime($date_header)) ?></h3>
            </td>
        </tr>
    </table>    
    <table style="border-collapse: collapse; margin-left: 9pt;" cellspacing="0">
        <tr>
            ...
            <td style="border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p class="s4" style="padding-top: 3pt;text-indent: 0pt;text-align: center;">Tanggal Dipakai</p>
            </td>
            <td style="border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
        ...
        <tr style="height:15pt">
            ...
            <td style="width:120pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p class="s5" style="padding-top: 3pt;padding-left: 3pt;text-indent: 0pt;text-align: left;"><?= $row->ket_det ?></p>
            </td>
            <td style="width:80pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p class="s5" style="padding-top: 3pt;text-indent: 0pt;text-align: left;"><?= $row->spesifikasi ?></p>
            </td>
            <td style="width:30pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p class="s5" style="padding-top: 3pt;text-indent: 0pt;text-align: center;"> <?= $row->qty ?> </p>
            </td>
        ...
        <?php } ?>
        <tr>
            <td colspan="8" style="border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p class="s5" style="padding-top: 3pt;padding-left: 3pt;text-indent: 0pt;text-align: left;">Keterangan : <?= $ket ?></p> <br>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2" style="border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p class="s4" style="padding-top: 3pt;padding-left: 3pt;text-indent: 0pt;text-align: center;">Mengetahui</p>
            </td>
            <td colspan="3" style="border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
