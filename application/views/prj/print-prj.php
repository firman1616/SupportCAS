...
<?php foreach ($header_prj as $row) {
    $prj = $row->rma;
    $date = date('d/m/Y', strtotime($row->date));
    $keterangan = $row->remark;
} ?>    
    ...
    <body>
        <table class="table_header">
            <tr>
                ...
                <td width="243">
                    <h1 style="padding-top: 4pt; padding-left: 0pt; text-indent: 0pt; line-height: 14pt; text-align: center; margin-bottom: 5px;">PR JASA</h1>
                    <table width="200" class="no_soe">
                        <tr>
                            <td style="text-align: center; font-weight: bold;"><?= $prj ?></td>
                        </tr>
                    </table>
        ...
        <table width="500" style="margin-left: 9pt;">
            <tr>
                <td width="500"><h3 style="padding-top: 4pt;text-indent: 0pt;text-align: right;">Tanggal</h3></td>
        ...
        <tr>
            ...
            <tr>
                <td colspan="3" style="border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                    <p class="s4" style="padding-top: 3pt;padding-left: 3pt;text-indent: 0pt;text-align: center;">Diperiksa oleh :</p>
                </td>
                <td colspan="3" style="border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
